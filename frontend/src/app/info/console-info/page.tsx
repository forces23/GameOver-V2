...
import { getAllTimeFavorites, getConsoleGamesById, getPlatformById } from '@/lib/api/igdb';
import { getPlatformDetails } from '@/lib/api/tgdb';
import { consoleTestData } from '@/lib/testData';
import { AllTimeFavs, ApiError, IGDBPlatformDetail, TGDBPlatformDetailsResponseData } from '@/lib/types';
...
export default function page() {
    ...
    const [games, setGames] = useState<AllTimeFavs[]>([]);
